...
public class DelayedTeleportSigilModel<T extends Entity> extends HierarchicalModel<T> {
	
	private final ModelPart main_particle;
	private final ModelPart rotate;
	private final ModelPart head;

	public DelayedTeleportSigilModel(ModelPart root) {
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animate(((DelayedTeleportSigilEntity) entity).idleAnimationState, ModAnimationDefinitions.sigil_idle, ageInTicks, 0.5f);
	}
