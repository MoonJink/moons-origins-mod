...
public class SummonWolfAttackGoal extends MeleeAttackGoal {
    private final SummonWolfEntity entity;
    private int attackDelay = 10;
    private int ticksUntilNextAttack = 0;
    private boolean shouldCountTillNextAttack = false;

    public SummonWolfAttackGoal(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
        super(pMob, pSpeedModifier, pFollowingTargetEvenIfNotSeen);
        entity = ((SummonWolfEntity) pMob);
    }
