...
public class LichLargeSummonedSkeletonAttackGoal extends MeleeAttackGoal {
    private final LichLargeSummonedSkeletonEntity entity;
    private int attackDelay = 7;
    private int ticksUntilNextAttack = 8;
    private boolean shouldCountTillNextAttack = false;

    public LichLargeSummonedSkeletonAttackGoal(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
        super(pMob, pSpeedModifier, pFollowingTargetEvenIfNotSeen);
        entity = ((LichLargeSummonedSkeletonEntity) pMob);
    }
